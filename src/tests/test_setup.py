...
def test_sdist() -> None:
    ...
    assert files == [
        ...
        *[f"mss-{__version__}/docs/source/release-history/{changelog.name}" for changelog in changelogs],
        ...
        f"mss-{__version__}/src/mss/buffer.py",
        ...
        f"mss-{__version__}/src/tests/third_party/array_frameworks/__init__.py",
        f"mss-{__version__}/src/tests/third_party/array_frameworks/conftest.py",
        f"mss-{__version__}/src/tests/third_party/array_frameworks/test_numpy.py",
        f"mss-{__version__}/src/tests/third_party/array_frameworks/test_numpy_method.py",
        f"mss-{__version__}/src/tests/third_party/array_frameworks/test_tensorflow_method.py",
        f"mss-{__version__}/src/tests/third_party/array_frameworks/test_torch_method.py",
